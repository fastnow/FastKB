...
// @version      1.0
// @description  可自由布局、双击编辑的网页虚拟键盘。支持宏、连发、手势、多配置等20+功能，完美适配触摸屏与桌面。让您在任意网页上拥有自定义的虚拟键盘，提升操作效率与游戏体验。
// @author       FastNow Studio
// @match        *://*/*
// @icon         https://fastly.jsdelivr.net/gh/fastnow/FastKB@main/assets/icon.jpg
// @updateURL    https://raw.githubusercontent.com/fastnow/FastKB/main/fastkb.user.js
// @license      MIT
// @grant        GM_setValue
// @grant        GM_getValue
